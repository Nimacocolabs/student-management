...
class _RegisterpageState extends State<Registerpage> {
  var _rkey=new GlobalKey<FormState>();
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                SizedBox(height: 30,),
                Center(child: Text("REGISTERATION",style: TextStyle(fontSize: 30),)),
                SizedBox(height: 30,),
                Padding(
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 30,right: 30),
                  child: CheckboxListTile(value: agree,
                      title: Text("I agree"),
                      onChanged: (value){
                        setState(() {
                          agree=value!;
                ...
                ElevatedButton(onPressed: (){
                  ...
                  showsanckbar(context, "Sucessfully Registered");
                }, child: Text("Register")),
              ],
            ),
          ),
